    <footer class="site-footer">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <p>
                        ...
                        <?php echo BUSINESS_CITY . ', ' . BUSINESS_PROVINCE . ' ' . BUSINESS_POSTAL; ?><br>
                        Tél: <?php echo BUSINESS_PHONE; ?><br>
                        Email: <a href="mailto:<?php echo BUSINESS_EMAIL; ?>"><?php echo BUSINESS_EMAIL; ?></a>
                    </p>
                </div>
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo date('Y'); ?> <?php echo BUSINESS_NAME; ?>. Tous droits réservés.</p>
            </div>
        </div>
    </footer>

    <!-- Banner Cookies - Loi 25 -->
